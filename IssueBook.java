...
public void clear(){
    ...
    "UPDATE library.book " +
    "SET status = 'Issued', issuedate = ?, duedate = ?, studentid = ?, " +
    "total_issues = total_issues + 1 " +  // Increment total_issues
    "WHERE id = ?"
);
...
if (rowsUpdated > 0) {
    ...
    JOptionPane.showMessageDialog(this, "Book ID not found. Please check again.");
}
