...
public class ReturnBook extends javax.swing.JFrame {
    ...
    try {
       ...
       "UPDATE library.book " +
       "SET status = 'NotIssue', issuedate = NULL, duedate = NULL, studentid = NULL, " +
       "total_returns = total_returns + 1 " + 
        "WHERE id = ?"
);
pst.setString(1, txtbookid.getText());  // Use Book ID
        ...
        if (rowsUpdated > 0) {
            ...
            JOptionPane.showMessageDialog(this, "Book ID not found. Please check and try again.");
        }
    } catch (SQLException ex) {
        Logger.getLogger(SignIn.class.getName()).log(Level.SEVERE, null, ex);
    }
